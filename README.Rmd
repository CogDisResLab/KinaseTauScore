...
[![BioC status](http://www.bioconductor.org/shields/build/release/bioc/KinaseTauScore.svg)](https://bioconductor.org/checkResults/release/bioc-LATEST/KinaseTauScore) [![Codecov test coverage](https://codecov.io/gh/CogDisResLab/KinaseTauScore/branch/main/graph/badge.svg)](https://app.codecov.io/gh/CogDisResLab/KinaseTauScore?branch=main)
...
[^1]:
    1.  Azorsa DO, Robeson RH, Frost D, et al. High-content siRNA screening of the kinome identifies kinases involved in Alzheimer’s disease-related tau hyperphosphorylation. BMC Genomics. 2010;11(1):25. <doi:10.1186/1471-2164-11-25>
